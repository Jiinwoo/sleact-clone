import React, {EventHandler, FC, ReactNode, useCallback, useEffect, useRef, VFC} from 'react'
...
const ChatBox: FC<Props> = ({children, chat, onSubmitForm, onChangeChat, placeholder}) => {
    ...
    const renderSuggestion = useCallback((
        ...
        return (<EachMention focus={focus}>
